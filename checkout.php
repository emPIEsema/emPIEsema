...
requireLogin(BASE_URL . '/checkout.php');
...
<?php if (empty($items) && empty($errors)): ?>
    ...
    <section class="cart-page">
        <h1>Checkout</h1>
        <p class="cart-empty">Your cart is empty. <a href="<?php echo BASE_URL; ?>/shop.php">Continue shopping →</a></p>
    </section>
...
<section class="checkout-page">
    ...
    <div class="checkout-cart">
                ...
                <tr>
                    <td>
                        <div class="checkout-product">
                            <img src="<?php echo BASE_URL; ?>/<?php echo htmlspecialchars($item['image']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>">
                            <div>
        ...
        <a href="<?php echo BASE_URL; ?>/cart.php" class="checkout-back"><i class="fa-solid fa-arrow-left"></i> Continue Shopping</a>
