...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($username === '' || $firstName === '' || $lastName === '' || $email === '' || $password === '' || $confirm === '') {
        ...
        $verifyUrl = (isset($_SERVER['HTTPS']) ? 'https://' : 'http://') . $_SERVER['HTTP_HOST']
            . BASE_URL . '/verify.php?token=' . urlencode($account['token']);
...
<div class="auth-page">
    ...
    <div class="auth-panel">
        ...
        <div class="auth-card">
            ...
            <a href="<?php echo BASE_URL; ?>/login.php?redirect=<?php echo urlencode($redirect); ?>" class="auth-submit" style="display:block; text-align:center; margin-top:8px; text-decoration:none;">Go to Login</a>
        ...
        <form class="auth-card" method="POST">
            ...
            <p class="auth-switch">Already have an account? <a href="<?php echo BASE_URL; ?>/login.php?redirect=<?php echo urlencode($redirect); ?>">Sign in</a></p>
