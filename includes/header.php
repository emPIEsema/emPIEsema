...
$cartHref = isLoggedIn() ? '/cart.php' : '/login.php?redirect=' . urlencode('/cart.php');
?>
<header>
    ...
    <div class="nav-icons">
        ...
        <?php if (isAdmin()): ?>
            <a href="/admin/index.php" title="Admin Panel">
                <i class="fa-solid fa-gauge"></i>
            </a>
        <?php endif; ?>

        <?php if (isLoggedIn()): ?>
            <a href="/logout.php" class="user-avatar" title="Logout (<?php echo htmlspecialchars(currentUsername()); ?>)">
