...
2 => [
    ...
    "left_specs" => ["Black", "Taurillon Monogram cowhide leather", "Taurillon cowhide-leather trim", "Textile lining", "Silver-tone hardware for Forest Green / Matte black-color hardware for Black"],
    "right_specs" => ["Main compartment with an inside pocket", "Front zipped pocket", "Small zipped pocket on top of the bag", "Strap: NOT REMOVABLE, ADJUSTABLE", "Strap drop: 27.5 cm", "Strap drop max: 48.7 cm"],
...
3 => [
    ...
    "left_specs" => ["Monogram Eclipse coated canvas", "Cowhide-leather trim", "Textile lining", "Silver-color hardware", "Flap with magnetic closure", "Zipped back pocket"],
    "right_specs" => ["2 inside flat pockets", "Inside front pocket", "Strap: NOT REMOVABLE, ADJUSTABLE", "Strap drop: 31.0 cm", "Strap drop max: 62.0 cm"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => null,
],
...
4 => [
    ...
    "left_specs" => ["Monogram Eclipse coated canvas", "Cowhide leather trim", "Textile lining", "Silver-color hardware", "Zip closure system", "Adjustable belt"],
    "right_specs" => ["Outside front pocket", "Outside back flat pocket", "Strap: NOT REMOVABLE, ADJUSTABLE", "Strap drop: 26.0 cm", "Strap drop max: 42.0 cm"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => "men",
],
...
5 => [
    ...
    "left_specs" => ["Indigo Blue", "Damoflage coated canvas", "Cowhide-leather trim", "Textile lining", "Aged-silver-tone hardware", "Zip closure", "Front zipped pocket", "Main compartment"],
    "right_specs" => ["Inside flat pocket", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 49.0 cm", "Strap drop max: 59.0 cm", "Handle: SIMPLE REMOVABLE"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => null,
],
...
6 => [
    ...
    "left_specs" => ["Monogram Empreinte Link Quartz", "Cowhide leather", "Cowhide-leather trim", "Microfiber lining", "Silver-toned hardware", "Magnetic closure", "Main compartment", "Inside zipped pocket", "Inside flat pocket"],
    "right_specs" => ["Fits: 6.7-inch smartphone, earphones, Romy Card Holder, sunglasses, keys, lipstick", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 22.5 cm", "Strap drop max: 44.0 cm", "Chain: REMOVABLE", "Chain drop: 18.5 cm"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => "women",
],
...
7 => [
    ...
    "left_specs" => ["Monogram coated canvas", "Cowhide-leather trim", "Textile lining", "Gold-toned hardware", "Fits: 11-inch tablet, smartphone, earphones, Clémence wallet, notebook, sunglasses"],
    "right_specs" => ["Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 43.0 cm", "Strap drop max: 51.0 cm", "Handle: SIMPLE"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => null,
],
...
8 => [
    ...
    "left_specs" => ["Monogram Emblème Rose Ruban", "Jacquard textile", "Cowhide-leather trim", "Cotton lining", "Gold-toned hardware", "Double zipper closure with padlock and keys", "Removable address tag", "Inside flat pocket"],
    "right_specs" => ["4 protective metal base feet", "Fits: smartphone, earphones, compact wallet, sunglasses", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 50.0 cm", "Strap drop max: 62.0 cm", "Handle: SIMPLE X2"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => null,
],
...
9 => [
    ...
    "left_specs" => ["Monogram Emblème Peuplier", "Jacquard textile", "Cowhide-leather trim", "Cotton lining", "Gold-toned hardware", "Hook closure", "4 side laces"],
    "right_specs" => ["Inside flat zipped pocket with textile lining", "Removable zipped pouch", "Removable address tag", "Fits: 13-inch laptop, 6.7-inch smartphone, earphones, long Zippy Wallet, book, sunglasses", "Handle: SIMPLE X2"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 1,
    "category" => null,
],
...
10 => [
    ...
    "left_specs" => ["Premium aluminium shell", "Vulcanised fibreboard panels", "Italian leather trim", "Leather telescopic trolley handle", "360° spinner wheels", "TSA-approved lock", "Cabin-size carry-on"],
    "right_specs" => ["Fits overhead compartments", "Leather carry handles", "Dual-compartment interior", "Adjustable compression straps", "Removable divider panel", "Silent multi-directional wheels"],
...
11 => [
    ...
    "left_specs" => ["Vulcanised fibreboard body", "Natural leather trim", "Leather handles", "Gold-tone hardware", "Four smooth-rolling wheels", "40-litre capacity"],
    "right_specs" => ["Leather-capped telescopic handle", "Cabin-size luggage", "Spacious interior compartment", "Ideal for short trips", "Handcrafted in England"],
...
12 => [
    ...
    "left_specs" => ["Vulcanised fibreboard body", "Black leather corners and straps", "Leather handles", "Oxblood interior", "Polished gold-tone hardware", "Cabin-size luggage"],
    "right_specs" => ["360° smooth-rolling wheels", "Leather telescopic handle", "Lightweight construction", "Ideal for 1–3 night trips", "Meets most airline cabin requirements"],
    "made" => "Handcrafted in England.",
...
13 => [
    ...
    "dimensions" => "56 × 42 × 21 cm",
    "left_specs" => ["Vulcanised fibreboard body", "Navy exterior finish", "Premium leather corners", "Leather handles", "Polished brass hardware", "PEANUTS™ exclusive artwork"],
    "right_specs" => ["360° smooth-rolling wheels", "Extendable telescopic handle", "Travel-inspired interior lining", "Cabin-size luggage", "Limited Edition collaboration"],
    "made" => "Handcrafted in England.",
    "material" => "Vulcanised Fibreboard & Leather",
    "featured" => 0,
    "category" => "travel",
...
14 => [
    ...
    "left_specs" => ["Vulcanised fibreboard body", "Natural leather corners and straps", "Leather-capped telescopic handle", "Polished gold-tone hardware", "96-litre capacity", "Four smooth-rolling wheels"],
    "right_specs" => ["Zip-secured lid lining", "Adjustable interior webbing straps", "Ideal for extended journeys", "Meets most airline check-in requirements", "Spacious main compartment"],
    "made" => "Handcrafted in England.",
    "material" => "Vulcanised Fibreboard & Natural Leather",
    "featured" => 0,
    "category" => "travel",
...
15 => [
    ...
    "left_specs" => ["Vulcanised fibreboard body", "Black leather corners and straps", "Leather-wrapped trolley handle", "Polished brass hardware", "83-litre capacity", "Four smooth-rolling wheels"],
    "right_specs" => ["Spacious interior compartment", "Adjustable interior webbing straps", "Ideal for 10–14 night trips", "Lightweight yet durable construction", "Ergonomic trolley handle"],
    "made" => "Handcrafted in England.",
    "material" => "Vulcanised Fibreboard & Leather",
    "featured" => 0,
    "category" => "travel",
...
16 => [
    ...
    "left_specs" => ["Khaki Green", "Monogram Eclipse coated canvas", "Cowhide-leather trim", "Textile lining", "Ruthenium-tone brass hardware", "Front flat pocket on main pouch"],
    "right_specs" => ["Inside flat pocket", "Removable small coin purse on strap", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 40.0 cm", "Strap drop max: 64.0 cm"],
...
18 => [
    ...
    "left_specs" => ["Khaki Green", "Monogram Eclipse coated canvas", "Cowhide-leather trim", "Textile lining", "Ruthenium-tone brass hardware", "Zip closure", "Main compartment"],
    "right_specs" => ["Removable leather nametag", "Inside flat pocket", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 43.0 cm", "Strap drop max: 65.0 cm", "Handle: SIMPLE X2"],
    "made" => "This reference is either Made in France, Spain, Italy or in the U.S.",
    "featured" => 0,
    "category" => "men",
],
...
19 => [
    ...
    "left_specs" => ["Black", "Monogram Shadow calfskin leather", "Cowhide-leather trim", "Textile lining", "Black-color hardware", "Front zipped pocket on flap", "2 front flat pockets under flap"],
    "right_specs" => ["Large main compartment fits an 11-inch tablet computer", "Inside flat pocket", "Front D-ring", "Strap: NOT REMOVABLE, ADJUSTABLE", "Strap drop max: 70.0 cm"],
    "made" => "This reference is either Made in France, Spain, Italy or in the U.S.",
    "featured" => 0,
    "category" => "men",
],
...
21 => [
    ...
    "left_specs" => ["Black", "Monogram coated canvas", "Natural-cowhide trim", "Textile lining", "Gold-color hardware", "Padlock", "Inside flat pocket"],
    "right_specs" => ["Fits: 6.7-inch smartphone, Lou wallet, keys, lipstick, tissues, sunglasses", "Weight: 0.6 kg", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 39.0 cm", "Strap drop max: 58.0 cm", "Handle: SIMPLE X2"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => "women",
],
...
22 => [
    ...
    "left_specs" => ["Monogram Empreinte Link Quartz", "Cowhide leather", "Cowhide-leather trim", "Microfiber lining", "Silver-toned hardware", "Flat pocket with 3 card slots"],
    "right_specs" => ["Gusseted compartment", "S-lock closure", "Fits: smartphone, compact wallet, lipstick", "Chain: ADJUSTABLE, REMOVABLE", "Chain drop: 55.0 cm", "Handle: SIMPLE"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => "women",
],
...
23 => [
    ...
    "left_specs" => ["Monogram Dune coated canvas", "Cowhide-leather trim", "Textile lining", "Gold-toned hardware", "Double zipper closure", "Padlock", "Inside flat pocket"],
    "right_specs" => ["Fits: 6.7-inch smartphone, Sarah Long Wallet, notebook, sunglasses, keys", "Strap: NOT REMOVABLE, ADJUSTABLE", "Strap drop: 28.0 cm", "Strap drop max: 31.0 cm", "Handle: SIMPLE X2"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => "women",
],
...
24 => [
    ...
    "left_specs" => ["Monogram Dune coated canvas", "Cowhide-leather trim", "Microfiber lining", "Gold-toned hardware", "Zipper closure", "Removable keybell with studs"],
    "right_specs" => ["Fits: 6.7-inch smartphone, earphones, Rosalie Coin Purse, sunglasses, keys, lipstick", "Strap: REMOVABLE, ADJUSTABLE", "Strap drop: 49.0 cm", "Strap drop max: 58.0 cm", "Chain: REMOVABLE", "Chain drop: 26.0 cm", "Handle: SIMPLE"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => "women",
],
...
25 => [
    ...
    "left_specs" => ["Monogram coated canvas", "Cowhide-leather trim", "Microfiber lining", "Gold-toned hardware", "Flap closure with magnetic S-lock"],
    "right_specs" => ["Inside zipped pocket", "Chain: SLIDING, NOT REMOVABLE", "Chain drop: 30.0 cm", "Chain drop max: 48.0 cm"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => "women",
],
...
26 => [
    ...
    "left_specs" => ["Monogram coated canvas", "Natural cowhide-leather trim", "Microfiber lining", "Gold-toned hardware", "Drawstring closure"],
    "right_specs" => ["Fits smartphone, wallet & keys", "Adjustable & removable leather strap", "Strap drop: 29.0 cm", "Maximum strap drop: 50.0 cm", "Interior flat pocket"],
    "made" => "Made in France, Spain or Italy, or Made in the U.S. of imported materials.",
    "featured" => 0,
    "category" => null,
],
...
27 => [
    ...
    "left_specs" => ["Product code: 2VZ110_2C26_F0038_V_MMO", "Removable padded woven nylon tape handle", "Flat leather handle", "Adjustable woven nylon harness straps", "Enameled metal triangle logo on the front"],
    "right_specs" => ["Flap, strap, buckle and magnetic closure", "Two external pockets", "Interior zipper pocket and patch pocket", "Logo-print Re-Nylon lining", "Imported"],
    "made" => "Made in Italy.",
    "featured" => 0,
    "category" => "backpack",
],
...
28 => [
    ...
    "left_specs" => ["Product code: 2VZ118_2DW3_F0038_V_OOO", "Padded nylon tape handle", "Adjustable woven nylon shoulder straps", "Enameled metal triangle logo on the flap", "Drawstring closure with flap and side-release buckle"],
    "right_specs" => ["Three external zipper pockets", "Back pocket with magnet", "Interior zipper pocket and patch pocket", "Re-Nylon lining", "Imported"],
    "made" => "Made in Italy.",
    "featured" => 0,
    "category" => "backpack",
],
...
29 => [
    ...
    "left_specs" => ["Product code: 2VZ135_2DMG_F0038_V_HOL", "Leather handle", "Adjustable woven nylon shoulder straps", "Enameled metal triangle logo on flap", "Push-lock clasp closure"],
    "right_specs" => ["Four external zipper pockets", "Padded mesh fabric back", "Interior zipper pocket and patch pocket", "Re-Nylon lining", "Imported"],
    "made" => "Made in Italy.",
    "featured" => 0,
    "category" => "backpack",
],
...
30 => [
    ...
    "left_specs" => ["Product code: 2VZ122_2DMG_F0002_V_OOO", "Adjustable technical cord detail", "Flat leather handle", "Adjustable fabric harness straps", "Enameled metal triangle logo on the front"],
    "right_specs" => ["Zipper closure", "Three external zipper pockets", "Bottle pocket with drawstring", "Padded mesh fabric back", "Interior zipper pocket and patch pocket", "Re-Nylon lining", "Imported"],
    "made" => "Made in Italy.",
    "featured" => 0,
    "category" => "backpack",
],
...
31 => [
    ...
    "left_specs" => ["Product code: 2VZ119_2HFQ_F0324_V_OOO", "Leather handle", "Adjustable leather harness straps", "Hot-stamped logo on the flap", "Flap and zipper closure"],
    "right_specs" => ["One external pocket with magnetic closure", "Interior zipper pocket", "Interior patch pockets", "Logo-print Re-Nylon and nappa leather lining", "Imported"],
    "made" => "Made in Italy.",
    "featured" => 0,
    "category" => "backpack",
],
